...
class kategori_ekonomi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kategori_economy)
        ...
        imageClick.setOnClickListener{
            val intent = Intent(this,ekonomi2::class.java)
            startActivity(intent)
        }
        imageClick2.setOnClickListener{
            val intent = Intent(this,ekonomi1::class.java)
            startActivity(intent)
        }
